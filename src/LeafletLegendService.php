...
/**
 * Provides a  LeafletLegendService class (override LeafletService).
 */
class LeafletLegendService extends LeafletService{
  ...
  public function leafletRenderMap(array $map, array $features = [], $height = '400px') {
    ...
    // Add the Leaflet Legend library and functionalities, if requested.
    if ($this->moduleHandler->moduleExists('leaflet_legend') && isset($map['settings']['legendControl']) && $map['settings']['legendControl']) {
      $attached_libraries[] = 'leaflet_legend/leaflet-legend';
      $attached_libraries[] = 'leaflet_legend/leaflet-legend-drupal';
    }
